        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoyaltyAmountPerPost = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserLogins", x => new { x.UserId, x.LoginProvider });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_AspNetUsers_CoachId",
                        column: x => x.CoachId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportTrips_Transports_TransportId",
            ...
            migrationBuilder.CreateTable(
                name: "EntertainmentBookingDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntertainmentBookingDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntertainmentBookingDetails_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EntertainmentBookingDetails_Shows_ShowId",
                        column: x => x.ShowId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtraServices_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AccommodationBookingDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccommodationBookingDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccommodationBookingDetails_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccommodationBookingDetails_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportBookingDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportBookingDetails_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransportBookingDetails_TransportTrips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccommodationBookingDetails_BookingId",
                table: "AccommodationBookingDetails",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_AccommodationBookingDetails_RoomId",
                table: "AccommodationBookingDetails",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntertainmentBookingDetails_BookingId",
                table: "EntertainmentBookingDetails",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_EntertainmentBookingDetails_ShowId",
                table: "EntertainmentBookingDetails",
                column: "ShowId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraServices_BookingId",
                table: "ExtraServices",
                column: "BookingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportBookingDetails_BookingId",
                table: "TransportBookingDetails",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportBookingDetails_TripId",
                table: "TransportBookingDetails",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportTrips_TransportId",
